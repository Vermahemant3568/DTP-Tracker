...
export default function DeleteTaskTypeDialog({ open, taskTypeName, loading, onConfirm, onCancel }: Props) {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white shadow-2xl p-6">
        ...
        <h3 className="text-base font-semibold text-gray-900">Delete Task Type</h3>
        <p className="mt-1.5 text-sm text-gray-500">
          Are you sure you want to delete{" "}
          <span className="font-medium text-gray-800">"{taskTypeName}"</span>?
          This may affect tasks that use this type.
        </p>
