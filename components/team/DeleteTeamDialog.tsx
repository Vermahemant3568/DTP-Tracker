...
export default function DeleteTeamDialog({ open, name, loading, onConfirm, onCancel }: DeleteTeamDialogProps) {
  if (!open) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white shadow-xl mx-4 p-6">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button onClick={onConfirm} disabled={loading} className="flex-1 h-9 rounded-lg bg-red-500 text-white text-sm font-medium hover:bg-red-600 disabled:opacity-60 transition-colors">
